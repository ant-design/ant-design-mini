...
function mapOptional(original) {
    if (platform() === 'wechat') {
        ...
        return __assign(__assign({}, rest), { properties: treansformProperties(props), lifetimes: {
                attached: function () {
...
function treansformProperties(props) {
    var properties = {};
...
Component(mapOptional({
    ...
    methods: {
        ...
        getProps: function () {
            if (platform() === 'wechat') {
                return __assign(__assign({}, this.data), { onSwipeStart: function () { }, onSwipeEnd: function () { } });
            }
            return this.props;
        },
        initWidth: function (func) {
            var _this = this;
            var _a = this.getProps(), leftButtons = _a.leftButtons, rightButtons = _a.rightButtons;
            console.log('initWidth', leftButtons, rightButtons);
        ...
        onItemTap: function (e) {
            ...
            if (!onButtonTap)
                return;
            var _b = e.target.dataset.item, itemL = _b.itemL, idx = _b.idx, item = _b.item;
