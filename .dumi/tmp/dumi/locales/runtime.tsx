...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/jiajia/Ali/Task/ant-design-mini/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/jiajia/Ali/Task/ant-design-mini/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/ant-design/ant-design-mini/edit/feat%2FaddThemeChange/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/ant-design/ant-design-mini/tree/feat%2FaddThemeChange/{fileName}#L{line}";
