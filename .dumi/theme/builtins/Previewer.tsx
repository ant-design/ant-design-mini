...
function getURL(url: string, pageQuery: Record<string, string>) {
  ...
  searchParams.set(
    'page',
    encodeURI(currentPAge + '?' + querystring.stringify(pageQuery))
  );
        ...
        <Popover
          content={
            <div style={{ textAlign: 'center' }}>
              <QRCodeSVG
                value={`alipays://platformapi/startapp?appId=2021003169685088&page=${page}`}
              />
            </div>
          }
