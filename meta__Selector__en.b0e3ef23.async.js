...
`,paraId:7,tocIndex:4},{value:"maxSelectedCount",paraId:8,tocIndex:5},{value:"\u3001",paraId:8,tocIndex:5},{value:"minSelectedCount",paraId:8,tocIndex:5},{value:" attribute can limit the number of selections,",paraId:8,tocIndex:5},{value:"selectMax",paraId:8,tocIndex:5},{value:"\u3001",paraId:8,tocIndex:5},{value:"selectMin",paraId:8,tocIndex:5},{value:" Event is triggered when the limit is exceeded.",paraId:8,tocIndex:5},{value:`<ant-selector
  options="{{options}}"
  multiple
  maxSelectedCount="{{4}}"
  minSelectedCount="{{2}}"
