...
`,paraId:5,tocIndex:3},{value:"Incoming ",paraId:6,tocIndex:4},{value:"disabled",paraId:6,tocIndex:4},{value:" property, disable the juxtaposition gray switch button.",paraId:6,tocIndex:4},{value:`<ant-switch defaultChecked="{{true}}" disabled="{{true}}" />
