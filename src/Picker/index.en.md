...
The Picker picker displays a scrollable list of one or more collections of options, enabling consistency between the iOS and Android-side experiences compared to native pickers.
...
| emptyText                    | Empty status button copy                                                                                                                                                              | string                                                                                                                                                                         | 'No data for the time'  |
