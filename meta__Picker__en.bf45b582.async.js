...
`,paraId:14,tocIndex:6},{value:"When more complex options appear, the need for linkage between options requires the introduction ",paraId:15,tocIndex:7},{value:"ant-cascader-picker",paraId:15,tocIndex:7},{value:" Cascade selection components to achieve. The component implements the cascading function by passing in the following tree structure:",paraId:15,tocIndex:7},{value:`<ant-cascader-picker
  options="{{cityList}}"
/>
