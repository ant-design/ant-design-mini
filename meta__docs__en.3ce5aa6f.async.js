...
`,paraId:10,tocIndex:4},{value:"The following is a list of components that have been adapted to WeChat applets in the antd-mini. You can use these components directly in the project.",paraId:11,tocIndex:5},{value:"For more details, please refer to the official documents of WeChat applet on npm support:",paraId:12,tocIndex:6},{value:"WeChat applet document: npm support",paraId:13,tocIndex:6}]},48048:function(o,a,e){e.r(a),e.d(a,{texts:function(){return n}});var t=e(50323);const n=[{value:"Here is a summary of resources related to Ant Design Mini.",paraId:0,tocIndex:0},{value:"Ant Design Mini related design resources and design tools are available here for download. More design resources are being sorted out and improved.",paraId:1,tocIndex:1}]}}]);
