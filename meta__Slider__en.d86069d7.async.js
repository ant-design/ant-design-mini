...
`,paraId:10,tocIndex:6},{value:"Incoming ",paraId:11,tocIndex:7},{value:"showTooltip",paraId:11,tocIndex:7},{value:" Property, you can display a hovering hint when dragging.",paraId:11,tocIndex:7},{value:`<ant-slider defaultValue="{{80}}" showTooltip />
#if ALIPAY
<!-- \u652F\u6301\u4F7F\u7528\u4F5C\u7528\u57DF\u63D2\u69FD\u81EA\u5B9A\u4E49 -->
...
#endif
`,paraId:12,tocIndex:7},{value:"value",paraId:13,tocIndex:8},{value:" property and ",paraId:13,tocIndex:8},{value:"change",paraId:13,tocIndex:8},{value:" Events, cooperation can achieve a controlled mode. Here's the example through ",paraId:13,tocIndex:8},{value:"ant-stepper",paraId:13,tocIndex:8},{value:" Component change ",paraId:13,tocIndex:8},{value:"value",paraId:13,tocIndex:8},{value:" Status,",paraId:13,tocIndex:8},{value:"ant-slider",paraId:13,tocIndex:8},{value:" Components ",paraId:13,tocIndex:8},{value:"value",paraId:13,tocIndex:8},{value:" States can also change together.",paraId:13,tocIndex:8},{value:`<ant-slider
  min="{{0}}"
  max="{{100}}"
  value="{{value}}"
#if ALIPAY
